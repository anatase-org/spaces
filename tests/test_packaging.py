...
class PackagingTests(unittest.TestCase):
    ...
    def test_systemd_templates_launch_unescaped_space_name(self) -> None:
        ...
        self.assertEqual(unit["Service"]["DelegateSubgroup"], "supervisor")
        ...
        self.assertIn(
            "allow spaces_container_t device_t:chr_file "
            "rw_chr_file_perms;",
            type_enforcement,
        )
        self.assertIn(
        ...
        self.assertIn(
            "allow spaces_container_t hsa_device_t:chr_file "
            "rw_chr_file_perms;",
            type_enforcement,
        )
        self.assertIn(
